       ...
       {data.data?.map(pokemon =>(
        <div key={pokemon.id} class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="p-5">
                ...
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 text-center">Type: {pokemon.type}</p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 text-center">HP: {pokemon.base.HP}</p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 text-center">Attack: {pokemon.base.Attack}</p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 text-center">Defense: {pokemon.base.Defense}</p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 text-center">Speed: {pokemon.base.Speed}</p>
