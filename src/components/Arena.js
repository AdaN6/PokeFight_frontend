        ...
        <div className='flex justify-center gap-20'>
          ...
          <div className="card">
            <div className="pkmn__container" >
              <div className="pkmn__picture">
                ...
                <img className="pkmn__png object-fill h-28" src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/${pokemon[2].id}.svg`} alt={pokemon[2].name.english} />
                <div className="pkmn__exp-bar"></div>				
              </div>
              <div className="pkmn__info">
                  <div className="pkmn__name">{pokemon[2].name.english}
                    <p className="size-medium"> Type: {pokemon[2].type[0]} {pokemon[2].type[1]}</p>
                  </div>
                  <div className="pkmn__data">
                    <div className="pkmn__type">{pokemon[2].base.Attack}<p className="text--small">Atack</p></div>
                    <div className="pkmn__weight">{pokemon[2].base.Defense}<p className="text--small">Defense</p></div>
                    <div className="pkmn__type">{pokemon[2].base.Speed}<p className="text--small">Speed</p></div>
                    <div className="pkmn__height">{pokemon[2].base.HP}<p className="text--small">HP</p></div>
                  </div>
          ...
          <div className="card">
            <div className="pkmn__container" >
              ...
              <div className="pkmn__info">
                  <div className="pkmn__name">{pokemon[201].name.english}
                    <p className="size-medium"> Type: {pokemon[201].type[0]} {pokemon[201].type[1]}</p>
                  </div>
                  <div className="pkmn__data">
